...
final class Back2Maps {
  ...
  public function enqueue_assets(){
    ...
    /*Data files */
    $states_url    = $base.'australian-states.min.geojson'; // states
    $divisions_url = $base.'regional_div.json';        // regional div
    $suburbs_url   = $base.'suburbs.json';             // optional
    $cio_url       = $base.'data/cio_loc_data.csv';    // csv loc data
