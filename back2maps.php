...
final class Back2Maps {
  ...
  public function enqueue_assets(){
    ...
    wp_enqueue_script('back2maps-js',  $base.'hates2map.js',
      ['leaflet-js','topojson-client','papaparse','xlsx','turf'],
      $js_ver, true);

    // ---- Data files ----
    $states_url    = $base.'australian-states.min.geojson';
    $divisions_url = $base.'regional_div.json';        // or .topo.json / .geojson
    $suburbs_url   = $base.'suburbs.json';
    $cio_url       = $base.'data/cio_loc_data.xlsx';   // <-- your file in /data
